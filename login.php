    ...
    <div class="container-fluid">
      ...
      <div class="row justify-content-center">
        <div class="col-xl-10 d-flex align-items-center justify-content-between">
          ...
          <a href="#sesion" class="get-started-btn scrollto">Iniciar Sesion</a>
        </div>
      </div>
  ...
  <section id="sesion" class="contact">
    <div class="container">
      ...
      <div class="section-title">
        <h2>LOG IN</h2>
        <p>Ingresa a gestionar tu tienda</p>
      </div>
    </div>
          ...
          <form action="validar.php" method="post">
            <div class="form-row">
              <div class="col-md-6 form-group">
                ...
                <input type="email" name="correo" class="form-control" id="correo" placeholder="Tu Correo Electronico" data-rule="minlen:6" data-msg="Porfavor ingresa un correo electronico valido." />
              ...
              <div class="col-md-6 form-group">
                ...
                <input type="password" name="pass" class="form-control" id="pass" placeholder="Tu Password" data-rule="minlen:5" data-msg="Porfavor ingresa al menos 25 caracteres" />
                <div class="validate"></div>
              </div>
